...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        if mother is None and father is None:
            ...
            # With parents: calculate inheritance probability
            ...
            prob_mother = get_pass_prob(mother)
            prob_father = get_pass_prob(father)

            if genes == 2:
                prob_gene = prob_mother * prob_father
            elif genes == 1:
                prob_gene = prob_mother * (1 - prob_father) + (1 - prob_mother) * prob_father
            else:
                prob_gene = (1 - prob_mother) * (1 - prob_father)

        # Trait probability always depends on gene count and Boolean trait
