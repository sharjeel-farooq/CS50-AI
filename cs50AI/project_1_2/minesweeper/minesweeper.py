...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        # Step 1: Mark move and safe
        self.moves_made.add(cell)
        self.mark_safe(cell)

        # Step 2: Create the set of neighboring cells
        ...
        # Step 3: Add new sentence to knowledge
        unknowns -= self.mines
        unknowns -= self.safes
        if unknowns:
        ...
        while changed:
            ...
            for new_sentence in new_sentences:
                if not new_sentence.cells.issubset(self.mines) and len(new_sentence.cells) > 0:
                    if not new_sentence.cells.issubset(self.safes):
    ...
    def get_neighbors(self, cell):
        """
        Returns the set of all neighboring cells of a given cell.
        """
        neighbors = set()
        i, j = cell
